...
graph TD
    ...
    %%================ STYLING ==================
    classDef core fill=#222,stroke=#00ffc6,stroke-width:2px,color=#e0fffa,font-weight:bold;
    classDef process fill=#111,stroke=#00b4ff,stroke-width:1.5px,color=#f0ffff;
    classDef decision fill=#000,stroke=#ff7b00,stroke-width:2px,color=#fff3e6,font-weight:bold;
    classDef terminal fill=#003,stroke=#00ff88,stroke-width:3px,color=#aaffdd,font-weight:bold;
